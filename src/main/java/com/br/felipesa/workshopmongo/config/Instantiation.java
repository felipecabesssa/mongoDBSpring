...
import com.br.felipesa.workshopmongo.dto.CommentDTO;
...
//      isso limpa nossa coleção la no mongo.		
		...
		CommentDTO c1 = new CommentDTO("Vai conseguir mano!", sdf.parse("22/03/2022"), new AuthorDTO(alex));
		CommentDTO c2 = new CommentDTO("Vaga ja é sua", sdf.parse("23/03/2018"), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia!", sdf.parse("24/03/2022"), new AuthorDTO(alex));
